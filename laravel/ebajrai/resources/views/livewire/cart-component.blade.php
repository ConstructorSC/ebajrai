        ...
        <div class="cart">
            ...
            @foreach (Cart::content() as $item)   
                ...
                <div style='padding-top:30px;'>
                    <button class="button-black" wire:click.prevent="decreaseQuantity('{{$item->rowId}}')">-</button>
                    {{$item->qty}}
                    <button class="button-green" wire:click.prevent="increaseQuantity('{{$item->rowId}}')">+</button> 									
                </div>
